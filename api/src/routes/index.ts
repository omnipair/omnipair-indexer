  ...
  res.json({
    ...
    endpoints: {
      v2: {
        ...
        auctions: 'GET /api/v2/markets/{marketAddress}/auctions?limit=100&offset=0',
        'auction-settlements': 'GET /api/v2/markets/{marketAddress}/auction-settlements?limit=100&offset=0',
