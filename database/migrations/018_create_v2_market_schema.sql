...
CREATE TABLE IF NOT EXISTS v2_markets (
    ...
    base_ylp_mint TEXT NOT NULL,
    quote_ylp_mint TEXT NOT NULL,
    base_hlp_mint TEXT NOT NULL,
    quote_hlp_mint TEXT NOT NULL,
    ...
    target_hlp_leverage_bps INTEGER NOT NULL,
