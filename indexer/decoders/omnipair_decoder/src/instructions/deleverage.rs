...
#[carbon(discriminator = "0x9e7f1bdeb7b223c2")]
pub struct Deleverage{
    pub args: DeleverageArgs,
}

#[derive(Debug, PartialEq, Eq, Clone, Hash, serde::Serialize, serde::Deserialize)]
pub struct DeleverageInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for Deleverage {
    type ArrangedAccounts = DeleverageInstructionAccounts;
    ...
    fn arrange_accounts(accounts: &[solana_instruction::AccountMeta]) -> Option<Self::ArrangedAccounts> {
        ...
        Some(DeleverageInstructionAccounts {
            pair,
            rate_model,
            leveraged_position,
            debt_vault,
