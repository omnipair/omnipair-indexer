  ...
  res.json({
    ...
    endpoints: {
      pools: {
        ...
        'paired-tokens': '/api/pools/paired-tokens/:token'
      },
      swaps: {
      ...
      positions: {
        ...
        'all-liquidity-positions': '/api/position/liquidity (optional: ?userAddress=ADDRESS&limit=50&offset=0)'
      }
    },
    parameters: {
      pairAddress: 'Required - The address of the trading pair to query data for',
      token: 'Required for paired-tokens endpoint - The address of the token to find paired tokens for',
    ...
    examples: {
      ...
      'Get tokens paired with a token': '/api/pools/paired-tokens/TOKEN_ADDRESS',
      ...
      'Get all liquidity positions': '/api/position/liquidity?limit=50&offset=0',
      'Get all liquidity positions filtered by userAddress': '/api/position/liquidity?userAddress=9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM&limit=50&offset=0'
    },
    notes: {
