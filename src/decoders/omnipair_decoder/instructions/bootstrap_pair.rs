...
#[carbon(discriminator = "0xb866152d6e5c868c")]
pub struct BootstrapPair{
    pub args: AddLiquidityArgs,
}

#[derive(Debug, PartialEq, Eq, Clone, Hash, serde::Serialize, serde::Deserialize)]
pub struct BootstrapPairInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for BootstrapPair {
    type ArrangedAccounts = BootstrapPairInstructionAccounts;
    ...
    fn arrange_accounts(accounts: &[solana_instruction::AccountMeta]) -> Option<Self::ArrangedAccounts> {
        ...
        Some(BootstrapPairInstructionAccounts {
            user,
            pair,
            rate_model,
            token0_vault,
